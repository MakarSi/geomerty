...
bool intersectrion_point_existence(Ray r1, Ray r2)
{
	...
	Point p1; 
	p1.set_x(h1.get_x() + (r1.get_vector()).x_coordinate_of_vector()); 
	p1.set_y(h1.get_y() + (r1.get_vector()).y_coordinate_of_vector());
	Point p2; 
	p2.set_x(h2.get_x() + (r2.get_vector()).x_coordinate_of_vector()); 
	p2.set_y(h2.get_y() + (r2.get_vector()).y_coordinate_of_vector());
	...
	if (v1.x_coordinate_of_vector() * v1_intr.x_coordinate_of_vector() >= 0 && v1.y_coordinate_of_vector() * v1_intr.y_coordinate_of_vector() >= 0)
		return true;
	return false;
}
